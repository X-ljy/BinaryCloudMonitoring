package com.binary.servermonitor.data_collection.data_api.image;
...
public class Inquire {
    ...
    private String json(String json,String id) {
        ...
        Gson gson = new Gson();
        return "{"+gson.toJson("TotalCount")+":"+gson.toJson(TotalCount)+","+gson.toJson("ImageSet")+":"+gson.toJson(ImageSet)+"}";
    }
}
