 ...
 * @author Wei Peng
 */
public class OneMinuteMonitorService implements Job {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        System.out.println("OneMonitot");
        List<WarnRule> warnRules = RepositoryUtil.getOneWarnRuleList();
            ...
            if ("and".equals(term)){
                ...
                for (int j = 0;j <this.list.size();j ++){
                    ...
                    if ("cpuUsed".equals(strategy.getOption())){
                        ...
                        ArrayList[] lists = service.getCpuUtil(hostIp.getHostip(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        System.out.println(DateTool.getOneStartTime());
    ...
    private void sentMail(WarnEmail warnEmail,String title,String messages){
        ...
        if (null != warnEmail.getEmail5() && temp5 != 0){
            ...
            if ("binary.com".equals(email[1])){
                ...
                System.out.println(warnEmail.getEmail5());
                try {
                    try {
