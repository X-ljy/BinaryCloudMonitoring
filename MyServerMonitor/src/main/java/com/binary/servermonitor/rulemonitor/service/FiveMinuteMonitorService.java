 ...
 * @author Wei Peng
 */
public class FiveMinuteMonitorService implements Job {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        System.out.println("FiveMonitorStart");
        List<WarnRule> warnRules = RepositoryUtil.getFiveWarnRuleList();
            ...
            if ("and".equals(term)){
                ...
                for (int j = 0;j <this.list.size();j ++){
                    ...
                    if ("cpuUsed".equals(strategy.getOption())){
                        Integer temp = outNum;
                        ArrayList[] lists = service.getCpuUtil(hostIp.getHostip(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        ...
                        Integer temp = outNum;
                        ArrayList[] lists = service.getMemUtil(hostIp.getHostip(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        outNum = outNum + judge(strategy,lists);
                        if (outNum > temp){
                        ...
                        Integer temp = outNum;
                        ArrayList[] lists = service.getDiskUtil(hostIp.getHostip(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        outNum = outNum + judge(strategy,lists);
                        if (outNum > temp){
                        ...
                        Integer temp = outNum;
                        ArrayList[] lists = service.getReadIoUtil(hostIp.getHostid(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        outNum = outNum + judge(strategy,lists);
                        if (outNum > temp){
                        ...
                        Integer temp = outNum;
                        ArrayList[] lists = service.getWriteIoUtil(hostIp.getHostid(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        outNum = outNum + judge(strategy,lists);
                        if (outNum > temp){
                            reason.append("磁盘读取IO超过阈值，");
                        }
                        ...
                        Integer temp = outNum;
                        ArrayList[] lists = service.getReadIopsUtil(hostIp.getHostid(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        outNum = outNum + judge(strategy,lists);
                        if (outNum > temp){
                        ...
                        Integer temp = outNum;
                        ArrayList[] lists = service.getWriteIopsUtil(hostIp.getHostid(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        outNum = outNum + judge(strategy,lists);
                        if (outNum > temp){
                        ...
                        Integer temp = outNum;
                        ArrayList[] lists = service.getIpInflowUtil(hostIp.getHostid(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        outNum = outNum + judge(strategy,lists);
                        if (outNum > temp){
                        ...
                        Integer temp = outNum;
                        ArrayList[] lists = service.getIpOutflowUtil(hostIp.getHostid(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        outNum = outNum + judge(strategy,lists);
                        if (outNum > temp){
                        ...
                        Integer temp = outNum;
                        ArrayList[] lists = service.getAverageLoadUtil(hostIp.getHostip(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        outNum = outNum + judge(strategy,lists);
                        if (outNum > temp){
                        ...
                        Integer temp = outNum;
                        ArrayList[] lists = service.getMysqlQpsUtil(hostIp.getHostip(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        outNum = outNum + judge(strategy,lists);
                        if (outNum > temp){
                        ...
                        Integer temp = outNum;
                        ArrayList[] lists = service.getMysqlTpsUtil(hostIp.getHostip(),50,DateTool.getOneStartTime(),DateTool.getEndTime());
                        outNum = outNum + judge(strategy,lists);
                        if (outNum > temp){
                ...
                for (int j = 0;j <this.list.size();j ++){
                    ...
                    if ("cpuUsed".equals(strategy.getOption())){
                        try {
                            ...
                            ArrayList[] lists = service.getCpuUtil(hostIp.getHostip(),50,DateTool.getStartTime(),DateTool.getEndTime());
